...
export bDecay=$6
export today=20200518_${multiScale}Multi_${extraConvPart}extraConvPart_${bDecay}bDecay

export fileg0=toyFlow_${today}_PtDep${ptdep}_Gran0_Scale${vnScale}
export fileg1=toyFlow_${today}_PtDep${ptdep}_Gran1_Scale${vnScale}

mkdir output/${fileg0}
mkdir output/${fileg1}

# ./toyFlow filename.root nEvents bUsePtDep bUseGran scale multiScale extraConvPart decays seedNum bSaveAsTrees
./toyFlow output/${fileg0}/${fileg0}.root ${evts} ${ptdep} 0 ${vnScale} ${multiScale} ${extraConvPart} 1000 0
./toyFlow output/${fileg1}/${fileg1}.root ${evts} ${ptdep} 1 ${vnScale} ${multiScale} ${extraConvPart} 1000 0
...
root -b -x -l -q "PlotCentralityData3sub_alice_ref.C(\"output/${fileg0}/\",2,6,${multiScale},${vnScale})"
root -b -x -l -q "PlotCentralityData3sub_alice_ref.C(\"output/${fileg1}/\",2,6,${multiScale},${vnScale})"
